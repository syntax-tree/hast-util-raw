 ...
 * @typedef {import('parse5').Token.CharacterToken} P5CharacterToken
 * @typedef {import('parse5').Token.CommentToken} P5CommentToken
 * @typedef {import('parse5').Token.DoctypeToken} P5DoctypeToken
 * @typedef {import('parse5').Token.TagToken} P5TagToken
